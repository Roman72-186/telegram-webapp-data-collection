...
| Фото 1    | Опциональное, base64 JPEG     |
| Фото 2    | Опциональное, base64 JPEG     |
| Фото 3    | Опциональное, base64 JPEG     |
...
- Проверить отправку с фото (base64 в payload)
